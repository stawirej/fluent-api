...
We will no longer rely on methods returning "this" as e.g. for builder pattern approach or other non-functional interface +
implementations for having fluent api from user perspective.
